...
public class GoogleWebLightBotDataTest {
    ...
    public void testGetIdentifier() throws Exception {
        assertEquals(GoogleWebLightBotData.getInstance().getIdentifier(), "GOOGLEWEBLIGHTBOT");
    }

    @Test
    public void testGetUserAgentChecker() throws Exception {
        UserAgent ua = uaa.parse("googleweblight");
        assertTrue(GoogleWebLightBotData.getInstance().getUserAgentChecker().test(ua));
        ...
        assertFalse(GoogleWebLightBotData.getInstance().getUserAgentChecker().test(ua));
    }

    @Test
    public void testGetIps() throws Exception {
        assertTrue(GoogleWebLightBotData.getInstance().getIps().isEmpty());
    }

    @Test
    public void testGetHostnames() throws Exception {
        assertEquals(GoogleWebLightBotData.getInstance().getHostnames(), ImmutableList.of("googlebot.com", "google.com"));
    }
